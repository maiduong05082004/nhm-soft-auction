                ...
                <div class="swiper-wrapper">
                    @foreach($this->list as $item)
                        <div class="!w-[400px] bg-center bg-cover swiper-slide">
                            <div class="block w-full max-w-sm bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
                                <div class="p-5">
                                    @if(!empty($item->badge))
                                        @php
                                            $badgeStyle = !empty($item->badge_color) ? "background-color: {$item->badge_color};" : "backgroud-color: '#ccc";
                                        @endphp
                                    ...
                                    <div class="flex flex-col gap-4 mb-4">
                                        ...
                                        {{-- Điểm --}}
                                        <h6 class="text-3xl font-bold text-gray-900 dark:text-white">{{$item->price}} POINT
                                            <span
                                                class="text-sm text-gray-500 dark:text-white">/ {{$item->duration}} tháng</span>
                                        </h6>
                                            ...
                                            <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
                                                ...
                                                @if($item->config['discount_percentage'] > 0)
                                                    <li class="flex items-center">
                                                        ...
                                                        Giảm {{$item->config['discount_percentage']}} % khi mua sản phẩm
                                                    </li>
                                                @endif
                                                ...
                                                @elseif($item->config['max_products_per_month'] > 0)
                                                    <li class="flex items-center">
                                                        ...
                                                        Miễn phí đăng bán {{$item->config->max_products_per_month}} sản
                                                        phẩm/ tháng
                                                    </li>
                                                @endif
                                    ...
                                    <x-filament::button wire:key="{{$item->id}}" class="w-full" color="success" icon="heroicon-m-check-badge"
    ...
    @else
            <x-filament::section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                    ...
                    <div class="block w-full max-w-sm bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700 h-fit">
                        <div class="p-5">
                            @if(!empty($membership->badge))
                                @php
                                    $badgeStyle = !empty($membership->badge_color) ? "background-color: {$membership->badge_color};" : "backgroud-color: '#ccc";
                                @endphp
                                <x-filament::badge size="sm" style="{{ $badgeStyle }}" class="mb-2">
                            ...
                            <div class="flex flex-col gap-4 mb-4">
                                ...
                                <h6 class="text-3xl font-bold text-gray-900 dark:text-white">{{$membership->price}} POINT
                                    <span
                                        class="text-sm text-gray-500 dark:text-white">/ {{$membership->duration}} tháng</span>
                                </h6>
                                <p class="text-gray-900 dark:text-white">
