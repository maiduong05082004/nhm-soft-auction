                    ...
                    <div class="max-w-sm">
                        ...
                        <div class="p-2">
                            <div class="flex flex-col gap-4">
                                ...
                                {{-- Điểm --}}
                                <h6 class="text-3xl font-bold text-gray-900 dark:text-white">{{$membership->membershipPlan->price}}
                                    POINT
                                    <span
                                        class="text-sm text-gray-500 dark:text-white">/ {{$membership->membershipPlan->duration}} tháng</span>
                                </h6>
                                ...
                                <div
                                    ...
                                    <ul class="max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
                                        <li>
                                            Ngày bắt
                                            đầu {{\Illuminate\Support\Carbon::make($membership->start_date)->format('d/m/Y')}}
                                        </li>
                                        <li>
                                            Ngày kết
                                            thúc {{\Illuminate\Support\Carbon::make($membership->end_date)->format('d/m/Y')}}
                                        </li>
                                    </ul>
                                </div>
                                <div
                                    ...
                                    <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
                                        ...
                                        @elseif($membership->membershipPlan->config['max_products_per_month'] > 0)
                                            <li class="flex items-center">
                                                ...
                                                Miễn phí đăng
                                                bán {{$membership->membershipPlan->config['max_products_per_month']}} sản
                                                phẩm/ tháng
                                            </li>
                                        @endif
                        ...
                        @foreach($membership->membershipTransaction as $transaction)
                            <div
                                ...
                                <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">
                                    Ngày giao
                                    dịch: {{\Illuminate\Support\Carbon::make($transaction->created_at)->format('d/m/Y H:i')}}
                                </p>
                                <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">
                                ...
                                <p class="font-normal text-gray-500 dark:text-gray-400">
                                    Trạng
                                    thái: {{ \App\Enums\Membership\MembershipTransactionStatus::getLabel($transaction->status) }}
                                </p>
                            </div>
                        @endforeach
                    </div>
