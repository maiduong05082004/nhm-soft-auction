<x-filament-panels::page>
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow p-6 sm:p-10">
            <h1 class="text-2xl font-bold text-gray-900 text-center" style="margin-bottom: 2rem;">
                QR Code Thanh Toán
            </h1>

            @if (!empty($this->sellerBreakdowns))
                @if (count($this->sellerBreakdowns) === 1)
                    <div class="flex justify-center">
                        @foreach ($this->sellerBreakdowns as $seller)
                            <div class="border rounded-xl p-6 flex flex-col items-center text-center bg-gray-50 max-w-md w-full">
                                <div class="mb-4">
            ...
            <div class="p-6 bg-blue-50 rounded-xl border border-blue-100" style="margin-bottom: 2rem; margin-top: 2rem;">
