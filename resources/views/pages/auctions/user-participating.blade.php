...
@section('title', 'Sản phẩm tôi đang đấu giá')

@section('content')
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Sản phẩm tôi đang đấu giá</h1>
        <p class="text-gray-600">Danh sách các sản phẩm bạn đang tham gia đấu giá</p>
    </div>
