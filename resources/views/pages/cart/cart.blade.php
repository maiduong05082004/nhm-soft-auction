                        ...
                        <div class="card bg-white shadow-xl rounded-lg p-6" id="cart-item-{{ $cartItem->product_id }}">
                            <div class="flex items-center space-x-4 py-6">
                                ...
                                <div class="flex items-center space-x-2">
                                    <button class="btn btn-neutral btn-outline w-10 h-10 quantity-btn"
                                    ...
                                    <input type="number" id="quantity-input-{{ $cartItem->product_id }}"
                                        ...
                                        max="{{ $cartItem->product->stock }}" class="input validator input-neutral"
                                        onchange="updateQuantityFromInput('{{ $cartItem->product_id }}', this.value)"
                                        onkeyup="updateQuantityFromInput('{{ $cartItem->product_id }}', this.value)">
                                    <button class="btn btn-neutral btn-outline w-10 h-10 quantity-btn"
                    ...
                    <div class="card card-border w-96 bg-base-100 card-xl shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="flex justify-between text-lg font-bold mb-6">
                                <span>Tổng cộng</span>
                                <span class="" id="cart-total">{{ number_format($total, 0, ',', '.') }}
                                    ₫</span>
                            </div>
